 ...
 * 
 * Disassembly of acpi_ssdt2.bin, Wed Oct 30 14:09:13 2013
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000993 (2451)
 *     Revision         0x01
 *     Checksum         0x0C
 *     OEM ID           "INSYDE"
 *     OEM Table ID     "CR CRB  "
 ...
 */
DefinitionBlock ("acpi_ssdt2.aml", "SSDT", 1, "INSYDE", "CR CRB  ", 0x00003000)
{

    External (_PR_.CPPC, FieldUnitObj)
    External (_PR_.CPU0, ProcessorObj)
    External (CFGD, IntObj)
    External (CPUD, FieldUnitObj)
    ...
    Scope (\_PR.CPU0)
    {
        ...
        {
            If (LOr (LEqual (INP4, One), LEqual (CPUD, One)))
            {
                Store (PPCM, \_PR.CPU0._PPC)
            }
            Else
            {
